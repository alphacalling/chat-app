        ...
        <div className="space-y-5 py-2">
            ...
            <div className="space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-3">
                {[
                  {
                    icon: Shield,
                    text: "Protect your account from unauthorized access",
                  },
                  {
                    icon: KeyRound,
                    text: "Use any authenticator app (Google, Authy, etc.)",
                  },
              ...
              <div className="flex gap-3 pt-2">
                <Button
                  ...
                  disabled={loading}
                  className="flex-1 bg-slate-700 hover:bg-slate-800 rounded-xl h-12 font-bold shadow-lg"
                >
                  {loading ? (
          ...
          {step === "qr" && qrCode && (
            <div className="space-y-5 animate-in fade-in zoom-in duration-500">
              {/* QR Code */}
              <div className="text-center bg-gray-50 p-5 rounded-2xl border-2 border-gray-200">
                <p className="text-gray-800 font-semibold mb-4">
                  Scan this QR code with your authenticator app
                </p>
                <div className="bg-white p-4 rounded-2xl inline-block shadow-xl border-2 border-gray-200">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="000000"
                  maxLength={6}
                  className="bg-gray-50 border-2 border-gray-200 focus:border-slate-400 text-center text-3xl font-mono tracking-[0.5em] h-14 rounded-xl"
                  autoFocus
                />
              </div>
              ...
              <div className="bg-yellow-50 p-4 rounded-2xl border-2 border-yellow-200">
                ...
                <div className="bg-white p-3 rounded-xl border-2 border-yellow-200 grid grid-cols-2 gap-2 max-h-28 overflow-y-auto">
                  {backupCodes.map((code, i) => (
                    <p
                      key={i}
                      className="text-xs font-mono text-yellow-900 bg-yellow-50 px-2 py-1 rounded"
                    >
                      {code}
                    </p>
                  ))}
                ...
                <p className="text-yellow-700 text-xs mt-2">
                  Save these codes in a safe place. Use them if you lose access
          ...
          {step === "verify" && (
            <div className="text-center space-y-5 animate-in fade-in zoom-in duration-500">
              <div className="relative inline-block">
                <div className="w-24 h-24 bg-emerald-100 rounded-full flex items-center justify-center mx-auto shadow-xl">
              ...
              <Button
                onClick={onClose}
                className="w-full bg-slate-700 hover:bg-slate-800 rounded-xl h-12 font-bold shadow-lg"
              >
                Continue to Login
              </Button>
            </div>
